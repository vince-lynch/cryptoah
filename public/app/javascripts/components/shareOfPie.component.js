var shareOfPie = {
  ...
  controller ($scope, $http, $timeout) {
    ...
    $scope.getTokenBalanceForAddress = function (address, totalSupply) {
      return $http({
        method: 'GET',
        url: 'https://api.etherscan.io/api?module=account&action=tokenbalance&contractaddress=0x1d29035eacc4a8bf72a9d776aa9e546cdd7dd946&address=' + address + '&tag=latest&apikey=DRDH19DFJ5G2S1GUZGYHJUQY39NQFBVIQJ'
      })
    }
    ...
    $scope.calculateTokenHolders = function (totalSupply) {
      $http({
        method: 'GET',
        url: 'https://api.etherscan.io/api?module=logs&action=getLogs&fromBlock=379224&toBlock=latest&address=0x1d29035eacc4a8bf72a9d776aa9e546cdd7dd946&apikey=DRDH19DFJ5G2S1GUZGYHJUQY39NQFBVIQJ'
      })
    ...
    var getTotalSupply = function () {
      $http({
        method: 'GET',
        url: 'https://api.etherscan.io/api?module=stats&action=tokensupply&contractaddress=0x1d29035eacc4a8bf72a9d776aa9e546cdd7dd946&apikey=DRDH19DFJ5G2S1GUZGYHJUQY39NQFBVIQJ'
      })
        .then(function successCallback (response) {
